...
export default function HomePage() {
  ...
  return <main className="shell">
    ...
    <div className="mobile-cart-jump"><button className="button secondary" onClick={scrollToPayment}>{t('cartJump')} <span aria-hidden="true">↓</span></button><button className="button secondary" onClick={newOrder}>{t('newOrder')}</button></div>
    <div className="grid">
